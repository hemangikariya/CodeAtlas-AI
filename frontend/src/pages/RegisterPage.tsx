...
import { Mail, Lock, ShieldAlert, Users } from 'lucide-react';
    ...
    <div className="min-h-screen w-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md p-8 rounded-2xl bg-surface border border-border/80 shadow-2xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-3xl font-extrabold text-textPrimary tracking-tight">Get Started</h2>
          <p className="text-textSecondary text-sm">Create an account to initialize CodeAtlas AI</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full pl-10 pr-4 py-3 rounded-lg bg-background border border-border text-sm text-textPrimary focus:outline-none focus:border-primary appearance-none transition duration-200"
              >
